...
(function () {
  ...
  var MIRROR_FRAG = [
    ...
    '  float fogEdge = smoothstep(0.3, 0.9, sDist);',
    ...
    '',
    '  // Sharpen wisps for visible tendrils',
    '  fogDensity = smoothstep(0.3, 0.7, fogDensity);',
    '',
    '  // Angular wisp variation — not uniform around edge',
    ...
    '  fogDensity *= fogEdge;',
    '',
    '  // Dark warm fog — obscures edges like smoke, creating the vignette',
