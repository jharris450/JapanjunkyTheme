...
(function () {
  ...
  var defaults = {
    ...
    noiseStrength: 0.4,
    displayScale: 2,
    glyphRamp: [32, 250, 248, 111, 153, 79, 48, 219],
    ditherStrength: 0.6,
    bloomStrength: 1.4,
    bloomRadius: 0.5,
    bloomThreshold: 0.06,
  ...
  var PARTICLE_RENDER_FRAG = [
    ...
    'out vec4 o_color;',
    'const vec3 PHOSPHOR = vec3(0.200, 1.000, 0.200);',
    'void main() {',
    '  vec3 color = PHOSPHOR;',
  ...
  var ASCII_FRAG = [
    ...
    'const vec3 PHOSPHOR_COLOR = vec3(0.200, 1.000, 0.200);',
    ...
    '  vec3 mono = PHOSPHOR_COLOR * lum;',
    '  o_color = vec4(mono * glyphAlpha, 1.0);',
    '}'
  ].join('\n');
