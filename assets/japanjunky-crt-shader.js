...
(function () {
  ...
  var CRT_FRAG = [
    ...
    '  float fogDist = length(center);',
    '  float fogEdge = smoothstep(0.2, 0.6, fogDist);',
    '  float fogAngle = atan(center.y, center.x);',
    '',
    '  float fA = fogAngle - uTime * 0.12;',
    '  float fog1 = sin(fA * 4.0 + fogDist * 10.0 - uTime * 0.25) * 0.5 + 0.5;',
    '  float fog2 = sin(fA * 6.0 - fogDist * 8.0 + uTime * 0.18) * 0.5 + 0.5;',
    '  float fog3 = sin(fA * 2.0 + fogDist * 14.0 - uTime * 0.35) * 0.5 + 0.5;',
    ...
    '  color = phosphorTint + caColor + vec3(bloom) * warmTint + fogColor * fogDensity + fogColor * fogDensity * 0.15;',
